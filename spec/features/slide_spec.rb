...
describe 'Slides' do
  fixtures :users, :slideshows, :slides

  before do
    sign_in_user users(:user1)
    visit slideshow_path(slideshows(:rspec_slideshow))
  end
  ...
  it 'User can create a slide' do
    ...
    click_on "Create"
    expect(current_path).to eq slideshow_path(slideshows(:rspec_slideshow))
    expect(Slide.find_by_title("A great slide!!")).not_to be_nil
  ...
  it 'User can view show page of a slide' do
    slide = Slide.find_by_title("I'm an rspec slide")
    click_on "I'm an rspec slide"
    expect(current_path).to eq slideshow_slide_path(slideshows(:rspec_slideshow), slide)
  ...
  it 'User can delete a slide' do
    ...
    expect(Slide.find_by_title("I'm an rspec slide")).to eq nil
